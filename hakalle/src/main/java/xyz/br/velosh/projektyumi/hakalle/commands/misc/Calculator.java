package xyz.br.velosh.projektyumi.hakalle.commands.misc;
 ...
 * Inline query command example.
 */
public class Calculator implements CommandBundle<For> {
    ...
    private String getResult(BigInteger value1, String op, BigInteger value2) {
        ...
        switch (op) {
            ...
            case "/" -> {
                ...
                else result += value1.divide(value2);
            }
            default -> { return null; }
        }
